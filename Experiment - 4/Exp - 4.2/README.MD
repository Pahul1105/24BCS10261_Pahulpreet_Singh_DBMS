...
Whenever a row doesn't have a corresponding row in the second table (right), those columns will be kept blank.
...
Why use LEFT JOIN over regular JOIN?
...
![Experiment 3.5 Output](leftjoins.png)
